    ...
    return React.createElement(RefCard, null,
        React.createElement("div", { className: "section-head" },
            React.createElement("div", null,
                ...
                React.createElement("p", null, "Rendimento do m\u00EAs atual \u2014 toque para analisar cada um"))),
        React.createElement("div", { className: "rank-yield-list" }, linhas.map(({ inv, rent }, i) => React.createElement("button", { className: "rank-yield-row", key: inv.id, onClick: () => onSelectInv(inv.id) },
