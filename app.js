...
function ReferenceDashboard({ ativos, totais, ganhoLiquido, metricsById, refTaxas, today, evolucao, setTab, period, setPeriod, diasAlerta }) {
...
function App() {
    ...
    if (showRelatorio)
        return React.createElement(RelatorioPrint, { ativos: ativos, historico: historico, totais: totais, ganhoLiquido: ganhoLiquido, metricsById: metricsById, refTaxas: ref, today: today, evolucao: evolucao, onClose: () => setShowRelatorio(false) });
    return React.createElement("div", { className: "ref-app" },
        ...
        React.createElement("main", null,
            tab === 'painel' && React.createElement(ReferenceDashboard, { ativos: ativos, totais: totais, ganhoLiquido: ganhoLiquido, metricsById: metricsById, refTaxas: ref, today: today, evolucao: evolucao, setTab: setTab, period: period, setPeriod: setPeriod, diasAlerta: diasAlerta }),
            " ",
            ...
            " ",
            tab === 'mais' && React.createElement(MoreScreen, { onDados: () => { setBackupMsg(''); setShowDados(true); }, onNew: openNew, setTab: setTab, refTaxas: refTaxas, taxaStatus: taxaStatus, onRefresh: refreshTaxas, onRelatorio: () => setShowRelatorio(true), historicoCount: historico.length, tema: tema, setTema: setTema, diasAlerta: diasAlerta, setDiasAlerta: setDiasAlerta, showSheet: showSheet, setShowSheet: setShowSheet })),
